    ...
    <div className="Loader_main">
      <main>
        ...
        <div class="message">
          ...
          <p class="message__line">Thank you for waiting...</p>
          <p class="message__line">
            Assembling one brick at a time for NeuralHQ.ai…
          </p>
          <p class="message__line">Following every step for NeuralHQ.ai…</p>
          <p class="message__line">
            Being very careful not to step on the pieces for NeuralHQ.ai…
          </p>
          <p class="message__line">
            Trying not to get finger blisters for NeuralHQ.ai…
          </p>
          <p class="message__line">
            Might take longer to build than the Death Star for NeuralHQ.ai…
          </p>
          <p class="message__line">Wrapping it up for NeuralHQ.ai…</p>
        </div>
      </main>
    </div>
  );
